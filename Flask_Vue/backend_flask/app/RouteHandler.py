...
class RouteHandler:
    ...
    def find_champion_loading_images_by_skin_number(self, champion_skin_number):
        db_result = self.dbHandler.find_champion_loading_images_by_skin_id(champion_skin_number)
        return db_result

    def count_loading_champion_image(self):
        cnt = self.dbHandler.count_document("IMG", "LOADING")
        return cnt
        
    def create_loading_images(self):
        ...
        for champion_id in champion_id_list:
            ...
            for chmapion_skin_number in champion_skin_numbers:
                ...
                self.insert_loading_image_by_champion_skin_number(champion_id, skin_numbering)

        # api_result = self.apiHandler.test_get_champion_loading_img_by_champion_skin_number(champion_skin_id)

    def insert_loading_image_by_champion_skin_number(self, champion_name, champion_skin_number):
        if self.dbHandler.find_champion_loading_images_by_skin_number(champion_skin_number) is None:
            api_result = self.apiHandler.test_get_champion_loading_img_by_champion_skin_number(champion_skin_number)
